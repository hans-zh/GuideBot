...
#define MOTORn							2
#define RIKI_MOTOR1_A_PIN           GPIO_PIN_0
#define RIKI_MOTOR1_B_PIN           GPIO_PIN_0
#define RIKI_MOTOR1_C_PIN			GPIO_PIN_14
// #define RIKI_MOTOR1_GPIO_PORT       GPIOC
// #define RIKI_MOTOR1_GPIO_CLK        RCC_APB2Periph_GPIOA

#define RIKI_MOTOR2_A_PIN           GPIO_PIN_1
#define RIKI_MOTOR2_B_PIN           GPIO_PIN_1
#define RIKI_MOTOR2_C_PIN			GPIO_PIN_15
// #define RIKI_MOTOR2_GPIO_PORT       GPIOE
